...
lpTag.taglets.ChatOverRestAPI = lpTag.taglets.ChatOverRestAPI || function(a) {
    ...
    function m() {
        function b(a) {
            var b;
            for (var c in a)
                if (a.hasOwnProperty(c) && 0 === String(c).indexOf("on") && da.hasOwnProperty(c)) {
    ...
    function H(a) {
        ...
        if (typeof a.customVariables === sa.OBJ)
    ...
    function X(a) {
        ...
        var b = !1;
        for (var c in a)
            if (a.hasOwnProperty(c) && ra.hasOwnProperty(c) && a[c] != ra[c] && "lastUpdate" !== c && "agentTyping" !== c && "visitorTyping" !== c && "state" !== c) {
                ra[c] = a[c];
                b = !0
            }
    ...
    da.getSiteDomain = function(a) {
        ...
        d.success = function(b) {
            ...
            if (b && b.ResultSet && b.ResultSet.lpData)
                for (var e = b.ResultSet.lpData, f = 0; f < e.length; f++) !c && e[f].lpServer && (c = e[f].lpServer);
            d = null;
    ...
    da.getExitSurvey = function(a) {
        ...
        c.success = function(b) {
            ...
            var d, e = ga.getPropertyFromObject(b, "body.survey");
            if (e) {
                ra.exitSurveyOn = !0;
                ba.changeKeepAliveState();
                d = {

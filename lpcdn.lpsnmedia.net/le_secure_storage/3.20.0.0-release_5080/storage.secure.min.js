...
window.lpTag.lzString = window.lpTag.lzString || function() {
    ...
    var i = {
        ...
        _compress: function(e, t, n) {
            if (null == e) return "";
            for (var r, o, a, i, s = {}, l = {}, c = "", u = 2, p = 3, g = 2, f = [], d = 0, m = 0, h = 0; h < e.length; h += 1) {
                a = e.charAt(h);
                ...
                i = c + a;
                if (Object.prototype.hasOwnProperty.call(s, i)) c = i;
                else {
        ...
        _decompress: function(e, t, n) {
            for (var r, o, a, i, s, l, c = [], u = 4, p = 4, g = 3, f = "", d = [], m = {
                    val: n(0),
                    position: t,
                    index: 1
                }, h = 0; h < 3; h += 1) c[h] = h;
...
lpTag.taglets.jsonp = lpTag.taglets.jsonp || function(c) {
        ...
        if (o && e && e.url) {
            ...
            try {
                n = function(e) {
                    ...
                    return 4 + (e.callback || u.callback).length + e.url.length + t + C(e.data).length + C(e.query).length
                }(e)
            } catch (e) {
    ...
    function w(e) {
        ...
        if (!b(e)) {
            ...
            D();
            e && e.error && j(p.ERROR, e.error, S(600, "Transport - JSONP - unable to run request: " + e.url), e.context);
            return !1
        }(e = function(e) {
            "string" == typeof e && (e = {
                url: e
            ...
            return e
        }(e)).callbackName && "string" == typeof e.callbackName ? e.retries = 0 : e.callbackName = n + k();
    ...
    function E() {
        for (var e in g)
            if (g.hasOwnProperty(e))
                for (var t = g[e], n = !1; !n && t.inFlight < 6 && 0 < t.length;) {
                    var r = t.shift();
                    if (r) {
    ...
    function O() {
        ...
        var e, t = new Date;
        for (e in h)
            if (h.hasOwnProperty(e) && h[e].launchTime) {
                var n = t - h[e].launchTime;
                (h[e].loadTime || n > h[e].timeout) && c[e].apply(null, [S(408, {
    ...
    function P(e) {
        for (var t = ["callUrl", "retries", "id", "requestTimeout", "type", "encoding", "launchTime", "callbackName", "domainMatch", "startTime"], n = 0; n < t.length; n++)
    ...
    var U = {
        ...
        configure: function(e) {
            if (e)
                for (var t in e) u.hasOwnProperty(t) && e.hasOwnProperty(t) && (u[t] = e[t]);
            v()
        },
        issueCall: w,
        isValidRequest: b,
...
lpTag.cookieMethods = lpTag.cookieMethods || function() {
    ...
    function s(e) {
        ...
        if (a || r || o && e.secure && "none" === e.sameSite) {
            ...
            try {
                document.cookie = [encodeURIComponent(e.name), "=", e.value, t ? "; expires=" + t.toUTCString() : "", e.path ? "; path=" + e.path : "", e.domain ? "; domain=" + e.domain : "", e.secure ? "; secure" : "", e.sameSite ? "; samesite=" + e.sameSite : ""].join("");
                n = !0
            } catch (e) {}
        }
        return n
...
lpTag.domainUtil = lpTag.domainUtil || function() {
    ...
    return {
        ...
        getParentDomain: function(e) {
            ...
            return null === r.top && null === r.country ? e : ((null === (n = r.top) || null !== r.country && r.country < n && n - 1 === r.country && t[r.country] !== l.sldRestricted[t[r.country]]) && (n = r.country), t.slice(0 < n ? n - 1 : n).join("."))
        },
        getDomain: c,
...
window.lpTag = window.lpTag || {};
window.lpTag.SessionCookieWrapper = window.lpTag.SessionCookieWrapper || function() {
    var r = lpTag.cookieMethods,
        o = lpTag.secureStorageUtils,
        e = r.isCookieEnabled() || !lpTag.firstParty && o.isChrome() && r.isChromeThirdPartyEnabled(),
        a = /[\-\.\+\*]/g,
        i = "\\@@SessionCookieWrapper",
        s = "https:" === location.protocol,
        l = !lpTag.firstParty && o.isChrome() ? "none" : "";
    return {
        set: function(e, t, n) {
            r.writeSessionCookie(e + "_lzw2".replace(a, i), o.lzwEncode(t), null, "/", null, s, l);
            o.runCallback(n, e || null)
        },
        get: function(e, t) {
            var n = null;
            if ("string" == typeof e) {
                n = r.readCookie(e + "_lzw2".replace(a, i));
                n = o.lzwDecode(n)
            }
            o.runCallback(t, n || null)
        },
        remove: function(e, t) {
            r.clearCookie(e + "_lzw2".replace(a, i), "/", null, s, l);
            o.runCallback(t, null)
        },
        isActive: function() {
            return e
        },
...
window.lpTag.IndexDBWrapper = window.lpTag.IndexDBWrapper || function(t, e) {
    ...
    function y() {
        var t;
        try {
            if (null === (t = m.open(o, 1))) return k(!1), void 0
        } catch (e) {
            k(!1);
            return
        }
    ...
    function w() {
        try {
            T(d.ADD, a, l, function(e) {
                e && e.error ? k(!1) : setTimeout(function() {
                    v(a, function(e) {
                        if (e === l) {
                            k(!0);
                            b(a)
    ...
    function T(e, t, n, r) {
        if (i) {
            var o, a = e === d.GET ? f.READONLY : f.READWRITE;
    ...
    function k(e) {
        if (e) h.runCallback(t, n);
        else if (p <= g) h.runCallback(t, null);
        else {
            g++;
            y()
        }
...
window.lpTag = window.lpTag || {};
window.lpTag.DataAnalyzer = window.lpTag.DataAnalyzer || function(e, t, n, r, o, a) {
    var i = 864e5,
        s = "1.0",
        l = "meta",
        c = lpTag.secureStorageUtils,
        u = new lpTag.DomainResolver(e, t, n, r, o, a);

    function p(e) {
        return !e || "string" != typeof e && "number" != typeof e ? i : +e
    }
    ...
    function g(e) {
        ...
        if (e)
            for (var r in e)
                if (e.hasOwnProperty(r) && !f(e[r], n) && u.isValidByLocations(e[r])) {
                    t = e[r].value;
                    break
                }
        return t
    ...
    return {
        getItems: function(e, t) {
            ...
            if (e)
                if ("*" !== t) r = g(e[t]);
                    ...
                    r = {};
                    for (var o in e) e.hasOwnProperty(o) && o !== l && (n = g(e[o])) && (r[o] = n);
                    r = c.hasProperties(r) ? r : null
                }
            return r
        },
        getItemId: function(e) {
            var t, n, r;
            for (r in e) e.hasOwnProperty(r) && u.isValidByLocations(e[r]) && (!n || e[r].ts > n) && (n = e[t = r].ts);
            return t
        },
        cleanupObject: function(e) {
            ...
            if (e && "object" == typeof e)
                for (var o in e) e.hasOwnProperty(o) && o !== l && (t = function(e, t) {
                    var n, r = {};
                    if (e && "object" == typeof e)
                        for (var o in e)
                            if (e.hasOwnProperty(o) && !f(e[o], t)) {
                                e[o].locations = u.cleanLocations(e[o].locations);
                                if (e[o].locations)
                                    if (u.isValidByLocations(e[o])) {
                                        if (!n || e[o].ts > e[n].ts) {
                                            n && r[n] && c.removeKeyFromObj(r, n);
                                            r[n = o] = e[o]
                                        }
                                    } else r[o] = e[o]
                            }
                    return c.hasProperties(r) ? r : null
                }(e[o], n)) && (r[o] = t);
            return c.hasProperties(r) ? (d(r), r) : null
        },
        enhanceObject: function(e, t, n) {
            var r, o, a = p(n.ttl),
                i = (new Date).getTime();
            e && "object" == typeof e || d(e = {});
            e[n.appName] || (e[n.appName] = {});
            t = t || c.getUID();
            r = e[n.appName][t] && e[n.appName][t].locations || {};
            r = u.updateLocations(r, n.origin, i);
            !(o = n.value) && c.isTouchRequest(n) && (o = e[n.appName][t] && e[n.appName][t].value);
            e[n.appName][t] = {
                value: o,
                locations: r,
                ttl: a,
...
window.lpTag.StorageSelector = window.lpTag.StorageSelector || function(e) {
    ...
    function m(e, t, n, r) {
        if (!r && n) t.get(u, m.bind(this, e, t, !1));
        else {
            p--;
            g[t.name][i] = function(e) {
                e = o.parseInteger(e);
    ...
    function h(e) {
        var t, n;
        for (n in g) g.hasOwnProperty(n) && g[n].storage && "number" == typeof g[n][e] && 0 <= g[n][e] && (!t || g[n][e] > t[e]) && (t = g[n]);
    ...
    return {
        createWrappers: function(t) {
            (o.isIE() || o.isSafari()) && !lpTag.firstParty || !0 !== e.localStorageEnabled || (g.localStorage.storage = new lpTag[g.localStorage.wrapperName]);
            !0 === e.cookiesEnabled && (g.secureSessionCookie.storage = new lpTag[g.secureSessionCookie.wrapperName]);
            !0 === e.sessionStorageEnabled && (g.sessionStorage.storage = new lpTag[g.sessionStorage.wrapperName](!0));
            if (o.isSafari() && !lpTag.firstParty) o.runCallback(t);
            else try {
                new lpTag[g.indexedDB.wrapperName](function(e) {
                    e && e.isActive() && (g.indexedDB.storage = e);
                    o.runCallback(t)
                })
            } catch (e) {
                o.runCallback(t)
        ...
        selectStorage: function(e, t, n, r) {
            ...
            if (g[e]) {
                ...
                y(r, t ? g[e].storage : g[e].storage || h(d))
            } else {
                var o = n,
                    a = (c("_selectStorageByTimestampOrPriority"), !1),
                    r = function() {
                        var e, t = [];
                        for (e in g) g.hasOwnProperty(e) && g[e].storage && t.push(g[e].storage);
                        return t
                    }(),
                    i = o ? o + "-" : "",
                    s = !!o;
...
window.lpTag = window.lpTag || {};
window.lpTag.DomainResolver = window.lpTag.DomainResolver || function(e, s, t, n, r, o) {
    var l, a = lpTag.secureStorageUtils,
        i = a.log.log,
        c = /^\*\.([^\.]+\.)*([^\.\s])+$/gi,
        u = ["liveperson.net", "liveperson.com", "lprnd.net", "lpsnmedia.net"],
        p = "boolean" == typeof t ? t : "true" === t,
        g = {
            DEV: "DEV",
            QA: "QA",
            ALPHA: "ALPHA",
        ...
        f = {};
    f[g.DEV] = f[g.QA] = "qtvr-wap06.dev.lprnd.net";
    f[g.ALPHA] = "accdn-a.lpsnmedia.net";
    f[g.GA] = "accdn.lpsnmedia.net";
    p ? function(e, t) {
        lpTag.taglets.jsonp.issueCall({
            url: "https://" + (o || f[n && n.toUpperCase()] || f[g.GA]) + "/api/account/" + e + "/configuration/domainprotection/refererrestrictions",
            timeout: 7e3,
            retries: 3,
            success: y(t),
            error: y(t),
    ...
    function d(e) {
        ...
        (e = l = e, Array.isArray(e) && 1 < e.length) && m(t) || (p = !(l = [t]));
        i("DomainResolver::setAllowedDomains: isCrossDomain=" + p);
        a.runCallback(r)
    }
    ...
    function m(e) {
        ...
        if (!a)
            for (var i = 0; i < l.length; i++) {
                t = l[i];
                c.lastIndex = null;
                if (a = c.test(t) ? (n = e, o = void 0, r = (r = t).substring(2), 0 <= (o = n.lastIndexOf(r)) && n.length === o + r.length) : lpTag.domainUtil.getParentDomain(e) === lpTag.domainUtil.getParentDomain(t)) break
            }
        return a
    }
    ...
    function y(t) {
        return function(e) {
            e = Array.isArray(e) && e.length ? e[0] : null, e = (e = e && Array.isArray(e.whiteList) ? e.whiteList : []).filter(function(e) {
                return "string" == typeof e
            });
            i("DataAnalyzer::_onWhiteListReceived whiteList:" + e.join(", "));
            a.runCallback(t, e)
        }
    }
    return {
        ...
        cleanLocations: function(e) {
            ...
            if (e && "object" == typeof e && 1 < t)
                for (var n in e) e.hasOwnProperty(n) && (p ? m(n) || a.removeKeyFromObj(e, n) : m(n) && a.removeKeyFromObj(e, n));
            return a.hasProperties(e) ? e : null
        },
        updateLocations: function(e, t, n) {
            h(t = lpTag.domainUtil.getParentDomain(t)) && a.hasProperties(e) || (e[t] = {
                ts: n
            });
            return e
        },
...
window.lpTag.SecureStorageManager = window.lpTag.SecureStorageManager || function(e) {
    ...
    t = e.app, o.hasValidStorageSelected(t) && window.setTimeout(function() {
        E(t, function(e, t) {
            b = "object" == typeof b ? b : {};
            for (var n in t = "object" == typeof t && t || b) {
                T("Got key in map: " + n);
                t.hasOwnProperty(n) && ! function(o, a) {
                    u(o, a, function(e) {
                        var t = k.cleanupObject(e),
                            n = (T("Got key " + a), o),
                            r = a;
    ...
    function S(e, t, n, r) {
        void 0 !== n && "" !== n && null !== n ? o.getStorage(e).set(t, w.encodeItem(n), r) : o.getStorage(e).remove(t, r)
    }

    function u(e, t, n) {
        o.getStorage(e).get(t, function(e) {
            w.runCallback(n, k.cleanupObject(w.decodeItem(e)))
        })
    }
    ...
    function E(e, t) {
        u(e, n, function(e) {
            "object" == typeof(b = e && !e.error ? e : {}) && null !== b || (b = {});
            w.runCallback(t, e);
            T("Got map: " + JSON.stringify(b))
        })
    }
    ...
    function O(e, t) {
        S(e, n, t, function(e) {
            b = e && !e.error ? t : {};
            T("Setting map: " + JSON.stringify(t))
        })
    }
    return {
        setItem: function(m, h, y) {
            ...
            (m = encodeURIComponent(m)) ? u(v, m, function(e) {
                if (!e && w.isTouchRequest(h)) w.runCallback(y, {
                    error: "No value to touch"
                });
                else {
                    u = v, p = m, e = e, g = h, f = y, d = k.getItemId(e && e[g.appName]), t = w.isTouchRequest(g);
                    if (void 0 === p || void 0 === g.value && !t)
                        if (!t && e && e[g.appName]) {
                            var r = u,
                                o = p,
                                t = d,
                                ...
                                a = f,
                                i = e;
                            i = w.removeKeyFromObj(i && i[n.appName], t);
                            w.hasProperties(i && i[n.appName]) || (i = w.removeKeyFromObj(i, n.appName));
                            w.hasProperties(i) ? S(r, o, i, function(e) {
                                w.runCallback(a, e && e.error ? e : null)
                            }) : C(r, o, function(e) {
                                w.runCallback(a, e);
                                e && e.error || (t = r, n = o, b && !b.hasOwnProperty(n)) || E(t, function() {
                                    if (b && b.hasOwnProperty(n)) {
                                        b[n] = null;
                                        delete b[n];
                                        O(t, b)
                                    }
                        ...
                        var s = u,
                            ...
                            c = f,
                            i = e;
                        (i = k.enhanceObject(i, t, n)) ? S(s, l, i, function(e) {
                            w.runCallback(c, e);
                            if (!e || !e.error) {
                                var t = s,
                                    n = l;
                                if (b) {
                                    if (!b.hasOwnProperty(n)) {
                                        b[n] = 1;
                                        O(t, b);
                                        T("Adding key to map: " + n)
                                    }
                                } else E(t, function() {
                                    if (!b.hasOwnProperty(n)) {
                                        b[n] = 1;
                                        O(t, b);
                                        T("Got Map, adding key to map: " + n)
                                    }
                                })
                            }
                        }): w.runCallback(c, {
        ...
        getItems: function(e, n, r) {
            ...
            e.forEach(function(e, t) {
                ...
                u(i, e, function(e) {
                    o = n.keys[t];
                    s[o] = e ? k.getItems(e, n.appName) : null;
                    if (0 === --a)
                        if (w.hasProperties(s)) l ? w.runCallback(r, s) : w.runCallback(r, s[o]);
                        else {
                            w.runCallback(r, null);
                            c("No value")
                        }
                })
            })
...
window.lpTag.SecureStorageClient = window.lpTag.SecureStorageClient || function(e, t) {
    var o, a, i = {},
        ...
        p = [],
        r = !1,
        g = "SecureStorageClient/storageType",
        f = {
    ...
    function v(e, t) {
        var n, r;
        if ("object" == typeof(n = e && e.data ? b(e.data) : n) && null !== n) {
            n = function(e) {
                var t;
                if (e.keys && Array.isArray(e.keys)) {
                    t = e.keys.filter(function(e) {
                        return "string" == typeof e && e !== g
                    });
                    e.keys = 0 < t.length ? t : null
                } else e.key && (e.key = "string" == typeof e.key && e.key !== g ? e.key : null);
                return e
            }(n);
            ...
            if (n.key || n.keys || r) {
                ...
                a.hasValidStorageSelected(n.app) ? r || (n.site && (n.value || n.ttl) ? function(e) {
                    i["" + e.site] = e.site;
                    o && o.setItem("" + e.site + e.key, e, w.bind(this, e))
                } : function(e) {
                    var t;
                    i["" + e.site] = e.site;
                    if (o) {
                    ...
                    a.selectStorage(e.initialStorageType, e.force, e.app, function(e, t, n) {
                        ...
                        ! function(e, t) {
                            ...
                            c[t.app] !== a.noStorageType.name ? e.value = c[t.app] : e.error = f.STORAGE;
                            T(e);
                            l("Notify Key: " + g + " Value: " + t.storage.name)
                        }(e, n)
                    }.bind(this, e, t))
                }(n, t) : w(n, {
    ...
    return {
        ...
        sendPendingMessages: function(t, e, n) {
            var r = n ? p.filter(function(e) {
                return !(!e || !e.data) && (e = b(e.data)) && e.type === n
            }) : p;
...
window.lpTag.StorageInitiator = window.lpTag.StorageInitiator || function(e) {
    ...
    function p() {
        ...
        o = new lpTag.DataAnalyzer(t.site, t.loc, t.isCrossDomain, t.env, f, t.accdn);
